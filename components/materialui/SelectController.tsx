...
export const SelectController = (props : UseControllerProps & UseControllerReturn & SelectProps & MenuItemsProps)  => {
  ...
  const {...customProps}:SelectProps = props;
    ...
    <Controller
      ...
      render={({ field: { onChange, onBlur, value, ref }, formState, fieldState }) => {
        ...
        <FormControl variant="standard">
          <InputLabel id="demo-multiple-checkbox-label" required={customProps.required} htmlFor="demo-multiple-checkbox">{props.label}</InputLabel> 
         <Select
          {...field}           
          fullWidth={true} 
  ...
  */}       {props.menuItems?.map((item, index) => {
        ...
        <FormHelperText id="outlined-weight-helper-text">{errorText}</FormHelperText>
      </ FormControl>
      </div> )
        }
    }
